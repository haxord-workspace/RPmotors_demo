        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-5">
              <div className="w-10 h-10 rounded-lg bg-gradient-gold flex items-center justify-center font-display font-bold text-gold-foreground">
                RP
              </div>
              <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Kerala's trusted destination for premium pre-owned cars. Quality, transparency and
              customer-first service since 2012.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              {[
                ...
                <li key={l}>
                  <span className="hover:text-gold transition-colors cursor-default">{l}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li>
                <a href="mailto:hello@rpmotors.in" className="hover:text-gold">
                  hello@rpmotors.in
                </a>
              </li>
            </ul>
            <div className="flex gap-3 mt-5">
              {[Facebook, Instagram, Youtube, MessageCircle].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-full glass flex items-center justify-center hover:bg-gradient-gold hover:text-gold-foreground transition-all"
                >
